...
import { Activity, LayoutDashboard, Users, Pill, FileClock, ClipboardList, DatabaseBackup } from "lucide-react";
    ...
    return (
      <div className="flex min-h-screen items-center justify-center px-4">
        <div className="max-w-md text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Akun Anda bukan admin.</p>
      ...
      <header className="sticky top-0 z-10 border-b bg-card/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold">IMO MANTAP — Admin</span>
          </div>
